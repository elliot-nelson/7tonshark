...
// Developer notes: this script generates a text-based banner
// from my blog posts, then calls a customized local version
// of ray-so to generate a PNG image from it. For more information,
...
function fixFiles(markdownPath) {
	...
	fs.renameSync(
		markdownPath,
		path.dirname(markdownPath) + "/" + baseName + "/" + baseName + ".md",
		{ overwrite: true }
	);
