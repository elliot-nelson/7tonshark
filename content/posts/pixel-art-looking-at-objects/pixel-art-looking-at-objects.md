...
{% image "./banner.png", "Pixel Art: Looking at Objects" %}
...
{% image "./ship-practice.png", "Pixel Art Spaceship Examples" %}
...
{% image "./raiden-2.png", "Tiles from the video game Raiden 2" %}
