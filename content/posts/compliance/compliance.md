...
date: 2026-02-24
tags: [ai, musings]
description: A virus that replicates itself by replacing human processes, and then expanding them until they are no longer sustainable.
banner_description: A virus that replicates itself by replacing and expanding human processes.
---

{% image "./banner.png", "Compliance" %}
